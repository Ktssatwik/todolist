...
//======= Admin Chatbot Section ======

// import { useState } from 'react';
// import { Button, Typography, Box, Input, Paper, Grid, TextField, Divider } from '@mui/material';

// const Admin = () => {
//   const [fileName, setFileName] = useState('');
//   const [userMessage, setUserMessage] = useState('');
//   const [chatLog, setChatLog] = useState([{ sender: 'Bot', message: 'Hello Admin! How can I help you today?' }]);
...
//       { sender: 'Bot', message: 'This is a mock response from Admin Bot.' }
//     ]);
//     setUserMessage('');
//   };
...
//             </Button>
//             <Typography variant="body1">{fileName || 'No file selected'}</Typography>
//           </Box>
//         </Paper>
//       </Grid>
...
//               <Box key={index} mb={1}>
//                 <Typography variant="subtitle2" color={entry.sender === 'User' ? 'primary' : 'secondary'}>
//                   {entry.sender}:
//                 </Typography>
...
import { useState } from 'react';
import { Box, Button, Grid, Paper, TextField, Typography, Input } from '@mui/material';

const Admin = () => {
  const [messages, setMessages] = useState([{ sender: 'Bot', text: 'Hello Admin! How can I help you today?' }]);
      ...
      <Paper sx={{ p: 2, mb: 2 }} elevation={1}>
        ...
        >
          {messages.map((msg, index) => (
            <Typography key={index} sx={{ color: msg.sender === 'Bot' ? 'blue' : 'black' }}>
