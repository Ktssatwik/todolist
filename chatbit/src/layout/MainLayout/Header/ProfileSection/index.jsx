...
export default function ProfileSection() {
  ...
  const handleLogout = async () => {
    ...
    try {
      const response = await fetch('http://localhost:8000/api/auth/jwt/logout/', {
        method: 'GET',
        headers: {
      ...
      if (response.ok) {
        ...
        // removing tokens freom the appplications , both of tokens
                  ...
                  <MainCard border={false} elevation={16} content={false} boxShadow shadow={theme.shadows[16]}>
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <ListItemIcon>
                            <IconLockPassword stroke={1.5} size="20px" />
                          </ListItemIcon>
                        ...
                        >
                          ...
                          <DialogContent sx={{ width: '400px' }}>
                            ...
                            <Box sx={{ position: 'relative', marginTop: '20px', marginBottom: '20px' }}>
                              <TextField
                                label="Email"
                                type="email"
                                fullWidth
                            ...
                            <Box sx={{ position: 'relative', marginTop: '20px', marginBottom: '20px' }}>
                              ...
                              >
                                {currentPwdVisible ? <FaEye /> : <FaEyeSlash />}
                              </IconButton>
                            </Box>

                            <Box sx={{ position: 'relative', marginBottom: '20px' }}>
                              <TextField label="New Password" type={newPwdVisible ? 'text' : 'password'} fullWidth variant="outlined" />
                              <IconButton
